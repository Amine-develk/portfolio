      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">Amine El kraiti</span>, a Web Designer from{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">Morocco</span>
          </h1>
